...
/// <summary>
/// PFGroupsAddSharedGroupMembersRequest data model.
/// </summary>
typedef struct PFGroupsAddSharedGroupMembersRequest
{
    /// <summary>
...
/// <summary>
/// PFGroupsCreateSharedGroupRequest data model. If SharedGroupId is specified, the service will attempt
/// to create a group with that identifier, and will return an error if it is already in use. If no SharedGroupId
/// is specified, a random identifier will be assigned.
/// </summary>
typedef struct PFGroupsCreateSharedGroupRequest
{
    /// <summary>
...
/// <summary>
/// PFGroupsCreateSharedGroupResult data model.
/// </summary>
typedef struct PFGroupsCreateSharedGroupResult
{
    /// <summary>
...
/// <summary>
/// PFGroupsGetSharedGroupDataRequest data model.
/// </summary>
typedef struct PFGroupsGetSharedGroupDataRequest
{
    /// <summary>
...
/// <summary>
/// PFGroupsSharedGroupDataRecord data model.
/// </summary>
typedef struct PFGroupsSharedGroupDataRecord
{
    /// <summary>
...
/// <summary>
/// PFGroupsGetSharedGroupDataResult data model.
/// </summary>
typedef struct PFGroupsGetSharedGroupDataResult
{
    /// <summary>
    /// (Optional) Data for the requested keys.
    /// </summary>
    struct PFGroupsSharedGroupDataRecordDictionaryEntry const* data;
...
/// <summary>
/// PFGroupsRemoveSharedGroupMembersRequest data model.
/// </summary>
typedef struct PFGroupsRemoveSharedGroupMembersRequest
{
    /// <summary>
    /// An array of unique PlayFab assigned ID of the user on whom the operation will be performed.
    /// </summary>
...
/// <summary>
/// PFGroupsUpdateSharedGroupDataRequest data model. Note that in the case of multiple calls to write
/// to the same shared group data keys, the last write received by the PlayFab service will determine
...
/// </summary>
typedef struct PFGroupsUpdateSharedGroupDataRequest
{
    /// <summary>
...
/// <summary>
/// PFGroupsDeleteSharedGroupRequest data model.
/// </summary>
typedef struct PFGroupsDeleteSharedGroupRequest
{
    /// <summary>
    /// Unique identifier for the shared group.
    /// </summary>
...
typedef struct PFGroupsAddMembersRequest
{
    ...
    /// </summary>
    PFEntityKey const* const* members;
...
typedef struct PFGroupsEntityWithLineage
{
    ...
    /// </summary>
    struct PFEntityKeyDictionaryEntry const* lineage;
...
typedef struct PFGroupsCreateGroupResponse
{
    ...
    /// </summary>
    struct PFStringDictionaryEntry const* roles;
...
typedef struct PFGroupsListGroupApplicationsResponse
{
    ...
    /// </summary>
    PFGroupsGroupApplication const* const* applications;
...
typedef struct PFGroupsListGroupBlocksResponse
{
    ...
    /// </summary>
    PFGroupsGroupBlock const* const* blockedEntities;
...
typedef struct PFGroupsListGroupInvitationsResponse
{
    ...
    /// </summary>
    PFGroupsGroupInvitation const* const* invitations;
...
typedef struct PFGroupsEntityMemberRole
{
    ...
    /// </summary>
    PFGroupsEntityWithLineage const* const* members;
...
typedef struct PFGroupsListGroupMembersResponse
{
    ...
    /// </summary>
    PFGroupsEntityMemberRole const* const* members;
...
typedef struct PFGroupsGroupWithRoles
{
    ...
    /// </summary>
    PFGroupsGroupRole const* const* roles;
...
typedef struct PFGroupsListMembershipResponse
{
    ...
    /// </summary>
    PFGroupsGroupWithRoles const* const* groups;
...
/// <summary>
/// Dictionary entry for an associative array with PFGroupsSharedGroupDataRecord values.
/// </summary>
typedef struct PFGroupsSharedGroupDataRecordDictionaryEntry
{
    const char* key;
    PFGroupsSharedGroupDataRecord* value;
