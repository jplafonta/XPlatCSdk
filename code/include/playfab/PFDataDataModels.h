...
typedef struct PFDataFinalizeFileUploadsResponse
{
    ...
    /// </summary>
    struct PFDataGetFileMetadataDictionaryEntry const* metadata;
...
typedef struct PFDataGetObjectsResponse
{
    ...
    /// </summary>
    struct PFDataObjectResultDictionaryEntry const* objects;
...
typedef struct PFDataInitiateFileUploadsResponse
{
    ...
    /// </summary>
    PFDataInitiateFileUploadMetadata const* const* uploadDetails;
...
typedef struct PFDataSetObjectsRequest
{
    ...
    /// </summary>
    PFDataSetObject const* const* objects;
...
typedef struct PFDataSetObjectsResponse
{
    ...
    /// </summary>
    PFDataSetObjectInfo const* const* setResults;
