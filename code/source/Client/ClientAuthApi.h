...
public:
    ...
    AsyncOp<SharedPtr<Entity>> LoginWithWindowsHello(const PlayFabClientLoginWithWindowsHelloRequest& request, const TaskQueue& queue) const;
    ...
    AsyncOp<SharedPtr<Entity>> RegisterWithWindowsHello(const PlayFabClientRegisterWithWindowsHelloRequest& request, const TaskQueue& queue) const;
