...
) noexcept
{
    ...
    *result = (PlayFabDataAbortFileUploadsResponse*)(std::dynamic_pointer_cast<AbortFileUploadsResponse>((*resultHandle)->result).get());
...
) noexcept
{
    ...
    RETURN_IF_FAILED(XAsyncGetResult(async, nullptr, sizeof(PlayFabResultHandle), resultHandle, nullptr));
    *result = (PlayFabDataDeleteFilesResponse*)(std::dynamic_pointer_cast<DeleteFilesResponse>((*resultHandle)->result).get());
...
) noexcept
{
    ...
    RETURN_IF_FAILED(XAsyncGetResult(async, nullptr, sizeof(PlayFabResultHandle), resultHandle, nullptr));
    *result = (PlayFabDataFinalizeFileUploadsResponse*)(std::dynamic_pointer_cast<FinalizeFileUploadsResponse>((*resultHandle)->result).get());
...
) noexcept
{
    ...
    RETURN_IF_FAILED(XAsyncGetResult(async, nullptr, sizeof(PlayFabResultHandle), resultHandle, nullptr));
    *result = (PlayFabDataGetFilesResponse*)(std::dynamic_pointer_cast<GetFilesResponse>((*resultHandle)->result).get());
...
) noexcept
{
    ...
    RETURN_IF_FAILED(XAsyncGetResult(async, nullptr, sizeof(PlayFabResultHandle), resultHandle, nullptr));
    *result = (PlayFabDataGetObjectsResponse*)(std::dynamic_pointer_cast<GetObjectsResponse>((*resultHandle)->result).get());
...
) noexcept
{
    ...
    RETURN_IF_FAILED(XAsyncGetResult(async, nullptr, sizeof(PlayFabResultHandle), resultHandle, nullptr));
    *result = (PlayFabDataInitiateFileUploadsResponse*)(std::dynamic_pointer_cast<InitiateFileUploadsResponse>((*resultHandle)->result).get());
...
) noexcept
{
    ...
    RETURN_IF_FAILED(XAsyncGetResult(async, nullptr, sizeof(PlayFabResultHandle), resultHandle, nullptr));
    *result = (PlayFabDataSetObjectsResponse*)(std::dynamic_pointer_cast<SetObjectsResponse>((*resultHandle)->result).get());
