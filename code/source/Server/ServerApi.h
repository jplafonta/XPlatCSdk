...
namespace PlayFab
{
    ...
    public:
        ...
        void AddFriend(ServerModels::AddFriendRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void AddGenericID(ServerModels::AddGenericIDRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void AddPlayerTag(ServerModels::AddPlayerTagRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void AddSharedGroupMembers(ServerModels::AddSharedGroupMembersRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void DeleteCharacterFromUser(ServerModels::DeleteCharacterFromUserRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void DeletePlayer(ServerModels::DeletePlayerRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void DeletePushNotificationTemplate(ServerModels::DeletePushNotificationTemplateRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void DeleteSharedGroup(ServerModels::DeleteSharedGroupRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void DeregisterGame(ServerModels::DeregisterGameRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void GetAllSegments(PlayFab::BaseRequest& request, const TaskQueue& queue, const ProcessApiCallback<ServerModels::GetAllSegmentsResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void GetTime(PlayFab::BaseRequest& request, const TaskQueue& queue, const ProcessApiCallback<ServerModels::GetTimeResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void LinkPSNAccount(ServerModels::LinkPSNAccountRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void LinkServerCustomId(ServerModels::LinkServerCustomIdRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void LinkXboxAccount(ServerModels::LinkXboxAccountRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void MoveItemToCharacterFromCharacter(ServerModels::MoveItemToCharacterFromCharacterRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void MoveItemToCharacterFromUser(ServerModels::MoveItemToCharacterFromUserRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void MoveItemToUserFromCharacter(ServerModels::MoveItemToUserFromCharacterRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void RefreshGameServerInstanceHeartbeat(ServerModels::RefreshGameServerInstanceHeartbeatRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void RemoveFriend(ServerModels::RemoveFriendRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void RemoveGenericID(ServerModels::RemoveGenericIDRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void RemovePlayerTag(ServerModels::RemovePlayerTagRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void RemoveSharedGroupMembers(ServerModels::RemoveSharedGroupMembersRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void RevokeInventoryItem(ServerModels::RevokeInventoryItemRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void SendCustomAccountRecoveryEmail(ServerModels::SendCustomAccountRecoveryEmailRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SendEmailFromTemplate(ServerModels::SendEmailFromTemplateRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SendPushNotification(ServerModels::SendPushNotificationRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SendPushNotificationFromTemplate(ServerModels::SendPushNotificationFromTemplateRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SetFriendTags(ServerModels::SetFriendTagsRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SetGameServerInstanceData(ServerModels::SetGameServerInstanceDataRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SetGameServerInstanceState(ServerModels::SetGameServerInstanceStateRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SetGameServerInstanceTags(ServerModels::SetGameServerInstanceTagsRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SetPlayerSecret(ServerModels::SetPlayerSecretRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SetPublisherData(ServerModels::SetPublisherDataRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SetTitleData(ServerModels::SetTitleDataRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SetTitleInternalData(ServerModels::SetTitleDataRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void UnlinkPSNAccount(ServerModels::UnlinkPSNAccountRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void UnlinkServerCustomId(ServerModels::UnlinkServerCustomIdRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void UnlinkXboxAccount(ServerModels::UnlinkXboxAccountRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void UpdateAvatarUrl(ServerModels::UpdateAvatarUrlRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void UpdateCharacterStatistics(ServerModels::UpdateCharacterStatisticsRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void UpdatePlayerStatistics(ServerModels::UpdatePlayerStatisticsRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void UpdateSharedGroupData(ServerModels::UpdateSharedGroupDataRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void UpdateUserInventoryItemCustomData(ServerModels::UpdateUserInventoryItemDataRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
