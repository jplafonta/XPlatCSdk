...
) noexcept
{
    ...
    auto provider = MakeAuthProvider(async, __FUNCTION__, std::bind(&AuthenticationAuthAPI::GetEntityToken, &stateHandle->state->authenticationAuthAPI, *request, std::placeholders::_1));
