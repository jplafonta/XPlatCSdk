...
) noexcept
{
    ...
    *result = (PlayFabExperimentationGetExclusionGroupsResult*)(std::dynamic_pointer_cast<GetExclusionGroupsResult>((*resultHandle)->result).get());
...
) noexcept
{
    ...
    RETURN_IF_FAILED(XAsyncGetResult(async, nullptr, sizeof(PlayFabResultHandle), resultHandle, nullptr));
    *result = (PlayFabExperimentationGetExclusionGroupTrafficResult*)(std::dynamic_pointer_cast<GetExclusionGroupTrafficResult>((*resultHandle)->result).get());
...
) noexcept
{
    ...
    RETURN_IF_FAILED(XAsyncGetResult(async, nullptr, sizeof(PlayFabResultHandle), resultHandle, nullptr));
    *result = (PlayFabExperimentationGetExperimentsResult*)(std::dynamic_pointer_cast<GetExperimentsResult>((*resultHandle)->result).get());
...
) noexcept
{
    ...
    RETURN_IF_FAILED(XAsyncGetResult(async, nullptr, sizeof(PlayFabResultHandle), resultHandle, nullptr));
    *result = (PlayFabExperimentationGetLatestScorecardResult*)(std::dynamic_pointer_cast<GetLatestScorecardResult>((*resultHandle)->result).get());
...
) noexcept
{
    ...
    RETURN_IF_FAILED(XAsyncGetResult(async, nullptr, sizeof(PlayFabResultHandle), resultHandle, nullptr));
    *result = (PlayFabExperimentationGetTreatmentAssignmentResult*)(std::dynamic_pointer_cast<GetTreatmentAssignmentResult>((*resultHandle)->result).get());
