...
namespace PlayFab
{
    ...
    public:
        ...
        // ------------ Generated API calls
        void AbortTaskInstance(AdminModels::AbortTaskInstanceRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void AddLocalizedNews(AdminModels::AddLocalizedNewsRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void AddPlayerTag(AdminModels::AddPlayerTagRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void AddVirtualCurrencyTypes(AdminModels::AddVirtualCurrencyTypesRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void CreateOpenIdConnection(AdminModels::CreateOpenIdConnectionRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void DeleteContent(AdminModels::DeleteContentRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void DeleteOpenIdConnection(AdminModels::DeleteOpenIdConnectionRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void DeletePlayer(AdminModels::DeletePlayerRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void DeletePlayerSharedSecret(AdminModels::DeletePlayerSharedSecretRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void DeleteStore(AdminModels::DeleteStoreRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void DeleteTask(AdminModels::DeleteTaskRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void DeleteTitle(PlayFab::BaseRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void DeleteTitleDataOverride(AdminModels::DeleteTitleDataOverrideRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void GetAllSegments(PlayFab::BaseRequest& request, const TaskQueue& queue, const ProcessApiCallback<AdminModels::GetAllSegmentsResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void GetCloudScriptVersions(PlayFab::BaseRequest& request, const TaskQueue& queue, const ProcessApiCallback<AdminModels::GetCloudScriptVersionsResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void GetPlayerSharedSecrets(PlayFab::BaseRequest& request, const TaskQueue& queue, const ProcessApiCallback<AdminModels::GetPlayerSharedSecretsResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void GetPlayerStatisticDefinitions(PlayFab::BaseRequest& request, const TaskQueue& queue, const ProcessApiCallback<AdminModels::GetPlayerStatisticDefinitionsResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void IncrementLimitedEditionItemAvailability(AdminModels::IncrementLimitedEditionItemAvailabilityRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void ListOpenIdConnection(PlayFab::BaseRequest& request, const TaskQueue& queue, const ProcessApiCallback<AdminModels::ListOpenIdConnectionResponse> callback, const ErrorCallback errorCallback = nullptr);
        void ListServerBuilds(PlayFab::BaseRequest& request, const TaskQueue& queue, const ProcessApiCallback<AdminModels::ListBuildsResult> callback, const ErrorCallback errorCallback = nullptr);
        void ListVirtualCurrencyTypes(PlayFab::BaseRequest& request, const TaskQueue& queue, const ProcessApiCallback<AdminModels::ListVirtualCurrencyTypesResult> callback, const ErrorCallback errorCallback = nullptr);
        void ModifyMatchmakerGameModes(AdminModels::ModifyMatchmakerGameModesRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void RemovePlayerTag(AdminModels::RemovePlayerTagRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void RemoveServerBuild(AdminModels::RemoveServerBuildRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void RemoveVirtualCurrencyTypes(AdminModels::RemoveVirtualCurrencyTypesRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void ResetCharacterStatistics(AdminModels::ResetCharacterStatisticsRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void ResetPassword(AdminModels::ResetPasswordRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void ResetUserStatistics(AdminModels::ResetUserStatisticsRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void RevokeInventoryItem(AdminModels::RevokeInventoryItemRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void SendAccountRecoveryEmail(AdminModels::SendAccountRecoveryEmailRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SetCatalogItems(AdminModels::UpdateCatalogItemsRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SetPlayerSecret(AdminModels::SetPlayerSecretRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SetPublishedRevision(AdminModels::SetPublishedRevisionRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SetPublisherData(AdminModels::SetPublisherDataRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SetStoreItems(AdminModels::UpdateStoreItemsRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SetTitleData(AdminModels::SetTitleDataRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SetTitleDataAndOverrides(AdminModels::SetTitleDataAndOverridesRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void SetTitleInternalData(AdminModels::SetTitleDataRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void UpdateCatalogItems(AdminModels::UpdateCatalogItemsRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void UpdateOpenIdConnection(AdminModels::UpdateOpenIdConnectionRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void UpdatePlayerSharedSecret(AdminModels::UpdatePlayerSharedSecretRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void UpdateRandomResultTables(AdminModels::UpdateRandomResultTablesRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        ...
        void UpdateStoreItems(AdminModels::UpdateStoreItemsRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
        void UpdateTask(AdminModels::UpdateTaskRequest& request, const TaskQueue& queue, const ProcessApiCallback<PlayFab::BaseResult> callback, const ErrorCallback errorCallback = nullptr);
