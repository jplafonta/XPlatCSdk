...
) noexcept
{
    ...
    auto provider = MakeEntityProvider(async, __FUNCTION__, contextHandle->entity, std::bind(&InsightsAPI::GetDetails, &contextHandle->entity->insightsAPI, InsightsEmptyRequest{ *request }, std::placeholders::_1));
...
) noexcept
{
    ...
    *result = (PlayFabInsightsInsightsGetDetailsResponse*)(std::dynamic_pointer_cast<InsightsGetDetailsResponse>((*resultHandle)->result).get());
...
) noexcept
{
    ...
    auto provider = MakeEntityProvider(async, __FUNCTION__, contextHandle->entity, std::bind(&InsightsAPI::GetLimits, &contextHandle->entity->insightsAPI, InsightsEmptyRequest{ *request }, std::placeholders::_1));
    return Provider::Run(UniquePtr<Provider>(provider.release()));
}
...
) noexcept
{
    ...
    RETURN_IF_FAILED(XAsyncGetResult(async, nullptr, sizeof(PlayFabResultHandle), resultHandle, nullptr));
    *result = (PlayFabInsightsInsightsGetLimitsResponse*)(std::dynamic_pointer_cast<InsightsGetLimitsResponse>((*resultHandle)->result).get());
...
) noexcept
{
    ...
    auto provider = MakeEntityProvider(async, __FUNCTION__, contextHandle->entity, std::bind(&InsightsAPI::GetOperationStatus, &contextHandle->entity->insightsAPI, InsightsGetOperationStatusRequest{ *request }, std::placeholders::_1));
    return Provider::Run(UniquePtr<Provider>(provider.release()));
}
...
) noexcept
{
    ...
    auto provider = MakeEntityProvider(async, __FUNCTION__, contextHandle->entity, std::bind(&InsightsAPI::GetPendingOperations, &contextHandle->entity->insightsAPI, InsightsGetPendingOperationsRequest{ *request }, std::placeholders::_1));
    return Provider::Run(UniquePtr<Provider>(provider.release()));
}
...
) noexcept
{
    ...
    RETURN_IF_FAILED(XAsyncGetResult(async, nullptr, sizeof(PlayFabResultHandle), resultHandle, nullptr));
    *result = (PlayFabInsightsInsightsGetPendingOperationsResponse*)(std::dynamic_pointer_cast<InsightsGetPendingOperationsResponse>((*resultHandle)->result).get());
...
) noexcept
{
    ...
    auto provider = MakeEntityProvider(async, __FUNCTION__, contextHandle->entity, std::bind(&InsightsAPI::SetPerformance, &contextHandle->entity->insightsAPI, InsightsSetPerformanceRequest{ *request }, std::placeholders::_1));
    return Provider::Run(UniquePtr<Provider>(provider.release()));
}
...
) noexcept
{
    ...
    auto provider = MakeEntityProvider(async, __FUNCTION__, contextHandle->entity, std::bind(&InsightsAPI::SetStorageRetention, &contextHandle->entity->insightsAPI, InsightsSetStorageRetentionRequest{ *request }, std::placeholders::_1));
    return Provider::Run(UniquePtr<Provider>(provider.release()));
}
