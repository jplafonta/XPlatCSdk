...
public:
    ...
    AsyncOp<MultiplayerModels::GetAssetDownloadUrlResponse> GetAssetDownloadUrl(const PlayFabMultiplayerGetAssetDownloadUrlRequest& request, const TaskQueue& queue) const; 
